              ...
              <div className="row justify-content-start outline products">
                <div className="col-2">
                  ...
                  <div className="productImg"> 
                    <img src={list.image} alt={list.desc} width="100px" onClick={() => handleShow(list)}/> 
                  </div>
                </div>
                <div className="col-3 Quantity">
                  <span>
                    <Button className="btn btn-secondary mx-1 ps-3" onClick={() => props.incrementValue(list)}>
                        <FontAwesomeIcon icon={faPlusCircle}/>
                    </Button> 
                    <Button className="btn btn-secondary mx-1 ps-3" onClick={() => props.decrementValue(list)}>
